...
for q in ['Какие условия должны быть выполнены для получения 592 услуги?']:
    print(q)
    print(answer(q, do_sample=True, top_p=0.9))
    print()
    print("True answer: ", 'место жительства или место пребывания в Санкт-Петербурге')
